...
회사에서 IntelliJ 프로젝트 설정 및 간단한 사용 방법을 개발팀 팀원들에게 발표하게 되었다. 이틀로 나누어 발표하였고, 첫날은 여덟 분, 둘째 날은 열한 분이 들어주셨다.
...
회사에서 무언가를 설명하는 발표는 처음인 만큼 서툴렀던 부분이 몇몇 있었지만, 향후에도 발표할 기회가 생기면 적극적으로 참여해보고, 열심히 갈고 닦아서 기술 관련 발표도 해보고 싶다.
