...
| - | 테더 (Tether) | 서클 (Circle) |
| --- | --- | --- |
| 공통점 | - 스테이블 코인 준비금에서 발생하는 이자 수익을 주된 수익원으로 삼음<br/>- 사용자에게 받은 법정 화폐(달러)를 안전자산에 투자하여 이자를 벌어들이는 방식<br/>- 최근의 고금리 환경에서 이 수익은 더욱 커졌으며, 테더는 2023년에 세계 최대 자산 운용 회사인 블랙록보다 더 많은 이익을 기록 |
